...
{{% onlyWhen mobi %}}
```bash
docker pull <docker-registry>/puzzle/k8s/kurs/php:7-apache
```
{{% /onlyWhen %}}
...
{{% onlyWhen mobi %}}
```bash
docker run -d --name apache-php <docker-registry>/puzzle/k8s/kurs/php:7-apache
```
{{% /onlyWhen %}}
...
{{% onlyWhen mobi %}}
```bash
docker run -p 8080:80 -d --name apache-php <docker-registry>/puzzle/k8s/kurs/php:7-apache
```
{{% /onlyWhen %}}
